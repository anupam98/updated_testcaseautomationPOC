...
SPREADSHEET_ID = "1-7OMc0ECnKyZXiifO16CYKuCpYnHYITLplhDDCEKiRo"
...
def main():
    ...
    try:
        ...
        for row in range (2,8):
            ...
            sheets.values().update(spreadsheetId=SPREADSHEET_ID,range=f"Sheet1!C{row}", valueInputOption="USER_ENTERED", body={"values": [[f"{calculation_result}"]]}).execute()
